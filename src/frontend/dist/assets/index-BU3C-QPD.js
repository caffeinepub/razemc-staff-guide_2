...
const rankGroups = [
  {
    ...
    color: "#ffd700",
    emoji: "👑",
    description: "Highest staff rank with full server administration and permission management.",
    categories: [
      {
        label: "Punishment",
        icon: "🔨",
  ...
  },
  {
    ...
    color: "#f59e0b",
    emoji: "🛡",
    description: "Server administrators with full moderation and admin panel access.",
    categories: [
      {
        label: "Punishment",
        icon: "🔨",
  ...
  },
  {
    ...
    color: "#a855f7",
    emoji: "⚔",
    description: "Senior Moderators with extended moderation powers and vault access.",
    categories: [
      {
        label: "Punishment",
        icon: "🔨",
  ...
  },
  {
    ...
    color: "#22c55e",
    emoji: "🟢",
    description: "Moderators enforcing server rules with ban and mute permissions.",
    categories: [
      {
        label: "Punishment",
        icon: "🔨",
  ...
  },
  {
    ...
    color: "#3b82f6",
    emoji: "🔵",
    description: "Junior Moderators with foundational ban, mute, and kick access.",
    categories: [
      {
        label: "Punishment",
        icon: "🔨",
  ...
  },
  {
    ...
    color: "#a78bfa",
    emoji: "🟣",
    description: "Helpers supporting players and moderating chat with mute access.",
    categories: [
      {
        label: "Utility",
        icon: "🧰",
  ...
  },
  {
    ...
    color: "#67e8f9",
    emoji: "🧪",
    description: "Trainees learning the ropes with basic mute, warn, and utility access.",
    categories: [
      {
        label: "Utility",
        icon: "🧰",
...
function CategoryBlock({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "10px" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "column", gap: "4px" }, children: cat.commands.map((cmd) => {
      const [cmdPart, descPart] = cmd.includes(" - ") ? cmd.split(/ - (.+)/) : [cmd, ""];
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          style: {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "code",
              {
                ...
                children: [
                  cmdPart,
                  descPart && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "span",
                    {
                      style: {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(CopyButton, { cmd: cmdPart, accentColor: color })
          ]
        },
        cmd
      );
...
function RankCard({ group }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      onMouseEnter: (e) => {
        e.currentTarget.style.boxShadow = `0 0 0 1px ${group.color}45, 0 12px 40px ${group.color}22`;
        e.currentTarget.style.transform = "translateY(-2px)";
      },
      onMouseLeave: (e) => {
        e.currentTarget.style.boxShadow = `0 0 0 1px ${group.color}10, 0 8px 32px ${group.color}10`;
      ...
      children: [
        ...
        open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: "16px 20px" }, children: group.categories.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx(CategoryBlock, { cat, color: group.color }, cat.label)) })
      ]
    }
  );
}
function StaffCommands({ searchQuery }) {
  const filtered = rankGroups.filter(
    (g) => !searchQuery || g.rank.toLowerCase().includes(searchQuery.toLowerCase()) || g.shortRank.toLowerCase().includes(searchQuery.toLowerCase()) || g.description.toLowerCase().includes(searchQuery.toLowerCase()) || g.categories.some(
      (cat) => cat.commands.some(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          ...
          children: "Official command permissions for each staff rank. Click a rank card to expand or collapse its commands."
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "column", gap: "14px" }, children: filtered.map((group) => /* @__PURE__ */ jsxRuntimeExports.jsx(RankCard, { group }, group.rank)) }),
    filtered.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: {
